...
//Сбор и обработка параметров (массив $arParams)
if(!isset($arParams["CACHE_TIME"]))
	$arParams["CACHE_TIME"] = 300;

$arParams["IBLOCK_TYPE"] = trim($arParams["IBLOCK_TYPE"]);

$arParams["IBLOCKS"] = intval($arParams["IBLOCKS"][0]);
...
if($this->startResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	while($arItem = $rsItems->GetNext())
	{
        ...
        $arItem['IBLOCK_SECTION_NAME'] = CIBlockSection::GetByID(intval($arItem['IBLOCK_SECTION_ID']))->GetNext()['NAME'];
...
//формирование кнопок для поддержки технологии «Эрмитаж» (удаление и изменение для каждого элемента в списке)
if(
